...
Patch0: suphp-0.7.1-httpd24.patch
...
%{__install} -Dp -m0644 suphp.httpd %{buildroot}%{_sysconfdir}/httpd/conf.d/mod_suphp.conf
...
%changelog
* Wed Jul 30 2014 Diana Soares <diana.soares@gmail.com> - 0.7.1-2
- Patch to build version 0.7.1 with Apache2.4.
- Use /etc/httpd/conf.d/mod_suphp.conf instead of .../conf.d/suphp.conf
